mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c adminLog -o d:/mongodb/adminLog.json
...
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c customerOptions -o d:/mongodb/customerOptions.json
...
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c frameworkTheme -o d:/mongodb/frameworkTheme.json
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c functionalFrameworks -o d:/mongodb/functionalFrameworks.json
...
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c permissions -o d:/mongodb/permissions.json
...
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c reportsfinal -o d:/mongodb/reportsfinal.json
...
mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c repoInfo -o d:/mongodb/repoInfo.json
echo icons
