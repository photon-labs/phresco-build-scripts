...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c adminLog -o /usr/local/work/Git/master/mongodb/adminLog.json
...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c customerOptions -o /usr/local/work/Git/master/mongodb/customerOptions.json
...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c frameworkTheme -o /usr/local/work/Git/master/mongodb/frameworkTheme.json
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c functionalFrameworks -o /usr/local/work/Git/master/mongodb/functionalFrameworks.json
...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c permissions -o /usr/local/work/Git/master/mongodb/permissions.json
...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c repoInfo -o /usr/local/work/Git/master/mongodb/repoInfo.json
...
./mongoexport -h 172.16.17.227 --port 27017 -d phresco-dev -c reportsfinal -o /usr/local/work/Git/master/mongodb/reportsfinal.json
